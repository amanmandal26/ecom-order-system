...
public class RabbitMQConfig {
    ...
    // Tells Spring AMQP to serialize/deserialize messages as JSON instead of
    // Java's default binary serialization (ObjectOutputStream). Both services must
    // use the same converter so the bytes written by order-service can be read here.
    @Bean
